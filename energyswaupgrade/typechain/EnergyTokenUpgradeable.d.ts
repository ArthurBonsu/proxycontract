...
interface EnergyTokenUpgradeableInterface extends ethers.utils.Interface {
  functions: {
    ...
    "energyidset(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "energyidset", values: [string]): string;
  encodeFunctionData(
...
export class EnergyTokenUpgradeable extends BaseContract {
  ...
  interface: EnergyTokenUpgradeableInterface;
  ...
  callStatic: {
    ...
    energyidset(_energyid: string, overrides?: CallOverrides): Promise<string>;
