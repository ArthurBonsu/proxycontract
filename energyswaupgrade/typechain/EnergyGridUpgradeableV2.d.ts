...
interface EnergyGridUpgradeableV2Interface extends ethers.utils.Interface {
  functions: {
...
export class EnergyGridUpgradeableV2 extends BaseContract {
  ...
  interface: EnergyGridUpgradeableV2Interface;
