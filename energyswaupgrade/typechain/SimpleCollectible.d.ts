...
interface SimpleCollectibleInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleCollectible extends BaseContract {
  ...
  interface: SimpleCollectibleInterface;
