...
interface RandomSVGInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "randomnumberreceived(uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "randomnumberreceived"): EventFragment;
...
export type CreatedRandomSVGEvent = TypedEvent<
...
export type randomnumberreceivedEvent = TypedEvent<
  [BigNumber] & { _randomnumber: BigNumber }
>;
...
export class RandomSVG extends BaseContract {
  ...
  filters: {
    ...
    "CreatedRandomSVG(uint256,string)"(
      tokenId?: BigNumberish | null,
      tokenURI?: null
    ): TypedEventFilter<
      [BigNumber, string],
    ...
    "randomnumberreceived(uint256)"(
      _randomnumber?: null
    ): TypedEventFilter<[BigNumber], { _randomnumber: BigNumber }>;
